...
async function doTask(agentDirectoryPath, taskName, feedback) {
  await fixTask(agentDirectoryPath, taskName, feedback);
  console.log(JSON.stringify({ result: `Task "${taskName}" fixed successfully.` }));
}