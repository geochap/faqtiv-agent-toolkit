...
async function doTask(agentDirectoryPath, runtime = 'javascript') {
  await initializeAgent(agentDirectoryPath, runtime);
  console.log(JSON.stringify({ result: `Faqtiv agent initialized successfully in "${agentDirectoryPath}" with runtime "${runtime}".` }));
}