...
async function doTask(agentDirectoryPath, name, content) {
  await addDocument(agentDirectoryPath, name, content);
  console.log(JSON.stringify({ result: `Document "${name}" added successfully.` }));
}