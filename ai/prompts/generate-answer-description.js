export function generateAnswerDescriptionPrompt(taskName) {
  const prompt = `
Given the doTask function you last generated, generate a function schema compatible with OpenAI function tool schema.
...
- Inclue a returns schema that must describe the return type as thoroughly as possible so to the best of your abilities infer the types from the code, for example "array" or "object" are not acceptable types unless their items or content properties are described.
